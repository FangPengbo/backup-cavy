...
public class BackUpJobVOToBackUpJob extends AbstractConvert<BackUpJobVO, BackUpJob>{
    @Override
    public List<BackUpJob> convert(List<BackUpJobVO> BackUpJobVOS) {
        return super.convert(BackUpJobVOS);
    }

    @Override
    public BackUpJob convert(BackUpJobVO t) {
        BackUpJob v = new BackUpJob();
        v.setId(t.getId());
